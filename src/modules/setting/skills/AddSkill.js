			...
			if (!err) {
				...
				apiClient.fetch('/skills', {
					...
					(response) => {
						...
						this.props.history.push('/skills/' + response.json.id);
						notification['success']({
							message: i18n.t`La compétence a bien été ajouté.`,
					...
					(error) => {
						error.response.json().then(
							(body) => {
								...
								this.setState({submitting: false});
								notification['error']({
									message: i18n.t`La compétence n'a pas été ajouté.`,
		...
		return(
			<div className="form">
				<div className="form-content">
					<Card title={
						<div className="form-title"><Icon type="plus-circle-o" /> <EditableTransWrapper><Trans>Ajouter une compétence</Trans></EditableTransWrapper></div>
					}>
						...
						<div className="form-buttons">
							...
							<Button size="large" onClick={() => this.props.history.push('/skills')}>
...
export default FormComp.create()(withI18n()(AddSkill));
