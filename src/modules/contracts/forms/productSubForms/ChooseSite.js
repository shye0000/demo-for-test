...
class ChooseSite extends React.Component {
	...
	async componentDidMount () {
		const {product, form, contract} = this.props;
		...
		if (product) {
			const site = product.subDivision.parent ?
				product.subDivision.parent['@id'] : product.subDivision['@id'];
			const zone = product.subDivision.parent ?
				product.subDivision['@id'] : undefined;
